    ...
    <div class="mx-auto max-w-7xl space-y-6">
      <section class="overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-sm">
        ...
        >
          ...
          <button
            class="rounded-full bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700"
          >
            Export report
          </button>
        </div>
        ...
        <div class="grid gap-4 p-6 md:grid-cols-2 xl:grid-cols-4">
          ...
          >
            <div class="flex items-center justify-between">
              ...
              <div
                :class="[
                  'flex h-11 w-11 items-center justify-center rounded-2xl text-lg text-white',
                  stat.iconBg,
                ]"
              >
                <i :class="stat.icon"></i>
        ...
        <div class="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div class="mt-6 rounded-[24px] border border-slate-200 bg-slate-50 p-4">
            <svg viewBox="0 0 400 180" class="h-44 w-full">
              <path
                d="M0 140 C40 120, 70 90, 100 100 S180 140, 220 110 S300 70, 340 80 S380 110, 400 70 L400 180 L0 180 Z"
                fill="#e0e7ff"
              />
              <path
                d="M0 138 C40 118, 70 88, 100 98 S180 138, 220 108 S300 68, 340 78 S380 108, 400 68"
                stroke="#4f46e5"
                stroke-width="4"
                fill="none"
        ...
        <div class="rounded-[32px] border border-slate-200 bg-slate-900 p-6 text-white shadow-sm">
          ...
          <div class="mt-5 space-y-3">
            <div
              ...
              :key="item.title"
              class="rounded-2xl bg-white/10 p-3 backdrop-blur"
            >
      ...
      <section class="grid gap-6 lg:grid-cols-2">
          ...
          <div class="mt-5 space-y-4">
            <div v-for="item in funnel" :key="item.label">
              ...
              <div class="h-2 rounded-full bg-slate-200">
                <div
                  :class="['h-2 rounded-full', item.barClass]"
        ...
        <div class="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div class="mt-5 space-y-3">
            ...
            >
              <div
                class="mt-1 flex h-9 w-9 items-center justify-center rounded-full bg-indigo-600 text-sm font-semibold text-white"
              >
                {{ update.icon }}
              </div>
              <div>
