<template>
  <div class="min-h-screen bg-slate-100 p-4 md:p-6">
    <div class="mx-auto max-w-7xl space-y-6">
      <section
        class="overflow-hidden rounded-[32px] border border-slate-200 bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 p-6 text-white shadow-sm"
      >
      ...
      <section class="grid gap-4 xl:grid-cols-[1.2fr_0.8fr]">
        <div class="grid gap-4 md:grid-cols-3">
          ...
          >
            <div class="flex items-center gap-4">
              <div
                :class="[
                  'flex h-12 w-12 items-center justify-center rounded-2xl text-lg text-white',
                  stat.iconBg,
                ]"
              >
                <i :class="stat.icon"></i>
        ...
        <div class="rounded-[28px] border border-slate-200 bg-slate-900 p-5 text-white shadow-sm">
          <div class="flex items-center justify-between">
            ...
            <span
              class="rounded-full bg-amber-500/20 px-3 py-1 text-xs font-semibold text-amber-300"
              >6 New</span
            >
          </div>
          <div class="mt-4 space-y-3">
            ...
            >
              <div class="flex items-center justify-between gap-3">
                ...
                <span
                  :class="['rounded-full px-2.5 py-1 text-xs font-semibold', item.badgeClass]"
                  >{{ item.status }}</span
                >
              </div>
