  ...
  <div class="min-h-screen bg-gray-100 p-6">
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 xl:grid-cols-4 gap-6">
        <div v-for="card in cards" :key="card.title" class="rounded-3xl bg-amber-400 p-6 border">
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-6">
        <section class="rounded-xl p-6 border border-gray-500">
          <div class="flex flex-col items-center text-center gap-4">
            <div
              class="h-24 w-24 rounded-3xl bg-slate-100 flex items-center justify-center text-slate-700 text-4xl"
            >
            ...
            <button
              class="rounded-full bg-blue-600 px-6 py-3 text-sm font-medium text-white hover:bg-blue-700 transition"
            >
      ...
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mt-6">
        ...
        <section class="rounded-3xl bg-white p-6 shadow-lg border border-slate-200">
          <div class="flex items-center justify-between mb-5">
            ...
            <button
              class="rounded-full bg-blue-600 px-5 py-2 text-sm font-semibold text-white hover:bg-blue-700 transition"
            >
              Add Recruiter
            </button>
          </div>
